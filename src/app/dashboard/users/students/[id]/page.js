    ...
    return (
      <Container maxWidth="false" className="mt-6 mb-12 gap-5 grid ">
        ...
        <Box className="rounded-2xl border border-slate-200 overflow-hidden">
          <Box className="px-8  flex-col flex justify-between bg-gradient-to-tr from-[#85afdb]">
            ...
            <Grid container spacing={3} className="">
              {[
                ...
                <Grid xs={12} sm={6} md={3} key={index}>
                  <Box
                    elevation={1}
                    className={`items-center h-full ${item.color} text-center justify-center p-5 rounded-2xl w-40 text-white transition-all duration-300 hover:scale-105 hover:-translate-y-1 `}
                  >
                    <Typography
                      variant="caption"
