...
export default function AllStudents() {
  ...
  const handleDelete = (deleteId) => {
    ...
    //
    if (Number(students.length) === Number(1)) {
  ...
  const finalFilteredStudents = students.filter((user) => {
